...
def query_llm(
    ...
    This method constructs a query incorporating both textual and visual information,
    then sends it to the specified LLM. This allows the LLM to leverage diverse
    data sources for a more informed response.
...
def simple_query_llm(model_url: str, question: str, pdfs: list,) -> dict:
    ...
    Returns:
      dict: A dictionary containing the answer from the language model.
            The dictionary has a single key, 'answer', which holds the answer string.
    """
